...
import papers from 'public/papers_features_dir.json';
import Highlighter from "react-highlight-words";
import Pagination from '@mui/material/Pagination';


const GetPapersdir = (props) => {
    const { info } = props;
                    ...
                    datapage.map(post => (
                        <li key={page + post.ID} align="start">
                            <div>
                                ...
                                <p className="body"><b>Challenge:</b>
                                    <text> {post.challenge}</text>
                                </p>

                                <p className="body"><b>Direction:</b>
                                    <text> {post.direction}</text>
                                </p>
