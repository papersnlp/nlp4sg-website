...
`;
  ...
  const customPalette = ['#00ac00', '#d30000', '#00aa98', '#cc9c9c', '#ff4500', '#00a97d', '#00a4bb', '#ffc900', '#d80000', '#670075', '#00aaa3', '#009fcb', '#00ca00', '#00aa8d', '#ffa900', '#ccf900', '#58ff00', '#0000d1', '#00fc00', '#0070dd',
    '#0092dd', '#63009e', '#004bdd', '#ecef00', '#009a00', '#0025dd', '#cc5c5c', '#1c0020', '#ff1500', '#0000dd', '#fcd200', '#00a200', '#ce0000', '#0000b1', '#ff9900', '#0000c1', '#7e008f', '#f2f2f2', '#ff7500', '#dc0000', '#ffb900', '#79008a',
    '#f2f2f2', '#00dc00', '#41004b', '#00a353', '#009adb', '#cc1c1c', '#00e700', '#00f200', '#f1e700', '#bcff00', '#1dff00', '#009e28', '#830094', '#0d00a8', '#007ddd', '#93ff00', '#3800a3', '#870098', '#00b700', '#00d400', '#ffc900', '#f2f2f2', '#f10000', '#00bf00', '#fc0000', '#000000', '#f2f2f2'];
  return (
