...
const Home = (props) => {
  ...
  return (
    <>
      ...
      <Box css={{pb: '$7'}}>
          <Box column center css={{ width: '100vw', height: '90vh', backgroundColor: '$contrast1', zIndex: 0 }}>
            <Box container column center>
              ...
              <Text mono css={{pt: '$3', zIndex: '1', color: '$contrast8'}}>Open paper visualization</Text>
            </Box>
          </Box>
